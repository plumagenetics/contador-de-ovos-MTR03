...
def parse_linha(linha, ano_escolhido):
    ...
    # Em algumas linhas o relatorio imprime "#####" no %POS.
    # Nesses casos, o TOTAL passa a ser o penultimo numero da linha.
    if "#####" in linha and len(numeros) >= 2:
        total = to_num(numeros[-2])
    elif len(numeros) >= 3:
